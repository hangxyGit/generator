...
public abstract class BaseRules implements Rules {
    ...
    /**
     * Implements the rule for generating the select by example without BLOBs
     * SQL Map element and DAO method. If the selectPagintionByExample statement is
     * allowed, then generate the element and method.
     *
     * @return true if the element and method should be generated
     */
    ...
    public boolean generateSelectPaginationByExampleWithoutBLOBs() {
        ...
        return tableConfiguration.isSelectPaginationByExampleStatementEnabled();
    }
    ...
    public boolean generateInsertOrUpdateBySelective() {
        ...
        return tableConfiguration.isInsertOrUpdateBySelectiveEnabled();
    }
    ...
    public boolean generateBatchInsert() {
        ...
        return tableConfiguration.isBatchInsertEnabled();
    }
