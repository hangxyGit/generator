...
public interface Plugin {
     ...
     * plugins.
     */
    boolean clientSelectPaginationByExampleWithoutBLOBsMethodGenerated(Method method,
                                                                       Interface interfaze, IntrospectedTable introspectedTable);


    boolean clientInsertOrUpdateBySelectiveMethodGenerated(Method method,
                                                           Interface interfaze, IntrospectedTable introspectedTable);


    boolean clientBatchInsertMethodGenerated(Method method,
                                             Interface interfaze, IntrospectedTable introspectedTable);


    boolean clientBatchUpdateMethodGenerated(Method method,
                                             Interface interfaze, IntrospectedTable introspectedTable);


    boolean clientBatchUpdateBySelectiveMethodGenerated(Method method,
                                                        Interface interfaze, IntrospectedTable introspectedTable);
    ...
    /**
     * This method is called when the selectPagintionByExample element is generated.
     *
     * @param element           the generated &lt;select&gt; element
     * @param introspectedTable The class containing information about the table as
     *                          introspected from the database
     ...
     * plugins.
     */
    boolean sqlMapSelectPaginationByExampleWithoutBLOBsElementGenerated(
            XmlElement element, IntrospectedTable introspectedTable);


    boolean sqlMapInsertOrUpdateBySelectiveElementGenerated(
            XmlElement element, IntrospectedTable introspectedTable);

    boolean sqlMapBatchInsertElementGenerated(
            XmlElement element, IntrospectedTable introspectedTable);


    boolean sqlBatchUpdateElementGenerated(
            XmlElement element, IntrospectedTable introspectedTable);


    boolean sqlMapBatchUpdateBySelectiveElementGenerated(
            XmlElement element, IntrospectedTable introspectedTable);
